...
const buttonVariants = cva(
  'max-w-fit px-6 py-3 rounded-full inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'font-semibold bg-primary text-primary-foreground hover:bg-primary/90 border-[1.2px] border-border shadow-[-2px_2px_0px_0px_black] ',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        secondary:
          'font-semibold bg-muted text-primary-foreground hover:bg-muted/90 border-[1.2px] border-border shadow-[-2px_2px_0px_0px_black] ',
        outline:
          'border border-input bg-background hover:bg-accent hover:text-accent-foreground',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-[#575151] underline-offset-4 hover:underline',
      },
      size: {
        default: 'h-10',
